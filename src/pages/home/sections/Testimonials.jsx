...
const testimonials = [
  {
    id: 1,
    name: "Alison",
    text: "JNELP’s shower gel keeps my skin refreshed and nourished. I love that it’s made with natural ingredients—it makes everything better!",
    image: pics,
  },
  {
    id: 2,
    name: "Diane",
    text: "JNELP’s black soap cleared my acne and made my skin feel cleaner and smoother. I highly recommend it!",
    image: picss,
  },
  {
    id: 3,
    name: "Micheal",
    text: "I bought JNELP’s skincare set for my mom, and she absolutely loves it! Her skin now glows, and she keeps asking for more products.",
    image: picsss,
  },
];
    ...
    <div>
      ...
      >
        ...
        <motion.div
          ...
          className="absolute top-14 left-6 bg-green-400 p-4 rounded-full"
        >
