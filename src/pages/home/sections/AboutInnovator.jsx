...
function AboutInnovator() {
  return (
    <section className="py-20 px-4 md:px-8 bg-[#019A28]">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-white">
            <motion.span
              ...
              className="text-white text-lg font-medium mb-4 block"
            >
              About Me
            </motion.span>
            ...
            >
              {stats.map((stat, index) => (
                ...
                >
                  <span className="block text-white text-3xl md:text-4xl font-bold mb-2">
                    {stat.number}
                  </span>
